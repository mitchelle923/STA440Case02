...
*insert answer for: Was your methodology fully appropriate? What alternative techniques might have been useful?*

write something about only being able to use 500 sims

### Data Limitations

We run our Monte Carlo simulations are a subsetted group of observations from 2022-2023 gymnastics competition data, and it is possible that this subset of data are not representative of the athletes' overall performances. Given our data prior to 2022 was not used because of the short athletic life-cycle of gymnasts and data only on women, we may have discarded pertinent data to some athletes' performances. Additionally, we had to remove data for athletes' scores when the athlete did not compete in more than 2 competitions for an apparatus, which may have excluded some potentially strong athletes if they had not competed in the 2022-2023 seasons due to injury, medical, or other reasons. Finally, given there are a limited number of international competitions per season, most athletes in the data set were competing in less than ten competitions--some only competing in 1 or 2 competitions across 2022-2023. The limited number of score results per athlete may lead to hard to generalize results.
