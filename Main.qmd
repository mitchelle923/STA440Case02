...
#            , Gender == gender) %>%
#     group_by(unique_id, Country) %>%
#     summarise(mean_estimate = analyze_athlete(Score, m_0 = m_0, sig_0 = sig_0, k_0 = k_0, v_0 = v_0, smc = 1000)[1],
#               var_estimate = analyze_athlete(Score, m_0 = m_0, sig_0 = sig_0, k_0 = k_0, v_0 = v_0, smc = 1000)[2],
...
# test_simul <- simulate_results(combined_final, "FX", "w", mu_0, sig_0, k_0, v_0, TRUE)
# head(test_simul)
```
