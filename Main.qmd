...
orderMenFinal <- menFinal %>% 
  ...
  dplyr::select(unique_id, Gender, Country,Competition, Round,Apparatus, Rank, D_Score, E_Score, Score)
```
...
#do not use this one for running sims
...
VT_w_simul <- simulate_full_competition(combined, "UB", "w", mu_0, sig_0, k_0, v_0, 100)
VT_w_simul |>
  head(10) |>
