...
>>>>>>> 91b3ff82939b8b2e03178f7668e0085e969f01fd
...
plot_invgamma = function(combined, app, g) {
    ...
    ggplot(aes(x = Score)) +
    geom_density() +
    stat_function(fun = d, args = list(normal_fit$estimate[[1]], normal_fit$estimate[[2]]), color = "red", linewidth = 1) +
    labs(title = paste(paste(app), "Total Score Dist. x Fitted Normal Prior"),  
         x = "Difficulty Score",
         y = "Density") +
     theme_minimal() +
    theme(legend.position = "none",
...
```{r}
# Lastly we want to compare the actual scores simulated by the posterior predictive distribution to the actual scores observed in the data. We do this by plotting the actual scores against the simulated scores for each apparatus.
...
plot_final_preds = function(data_23, app, g) {
  ...
  data_23 %>%
    ...
    ggplot() +
      ...
      labs(title = paste(app, "Scores x Simulated Scores"),
...
=======
  ...
  mutate(unique_id = case_when(
                               ...
                               unique_id == "FreRIC_USA" ~ "Frederick Richard: USA")) |>
  kable(caption = "Top 10 Average Ranks of USA Male Athletes By Number of Gold Medals", col.names = c("Athlete & Country", "Average Rank")) |>
>>>>>>> 91b3ff82939b8b2e03178f7668e0085e969f01fd
  kable_styling(font_size = 8, latex_options = "HOLD_position")
