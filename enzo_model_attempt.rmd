...
analyze_athlete = function(athlete_results, smc, m_0, sig_0, k_0, v_0) {
  ...
  sig_sample = rinvgamma(smc, v_n/2, sig_n*v_n/2)
  theta_sample = rnorm(smc, m_n, sqrt(sig_sample/k_n))
