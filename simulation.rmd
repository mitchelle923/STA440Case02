...
simulate_full_competition = function(data, apparatus, gender, mu_0, sig_0, k_0, v_0, smc = 1000) {
...
prior_parameters = suppressWarnings(fit_normal_priors(data_23, "HB", "m"))
...
test_simul = simulate_full_competition(data_23, "HB", "m", mu_0, sig_0, k_0, v_0, 100)
head(test_simul)
```
