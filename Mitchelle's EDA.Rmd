...
orderMenFinal <- menFinal %>% 
  arrange(Competition, Round, Country,desc(Score)) %>% 
...
for (i in 2:nrow(orderMenFinal)){
  if ((orderMenFinal$Competition[i] == orderMenFinal$Competition[i-1]) & (orderMenFinal$Country[i] != orderMenFinal$Country[i-1])) {
